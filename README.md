...
#### Users
`- is responsible for storing necessary data upon the creation of a user and when its modified. &nbsp It is dependent to either two (2) entities: Students & Authors`
